...
const EditProfile = () => {
  ...
  useEffect(() => {
    if (access_token) {
      axios
        .post(import.meta.env.VITE_SERVER_DOMAIN + "/api/blogs/get-profile", {
  ...
  const handleImageUpload = (e) => {
    ...
    if (updatedProfileImage) {
      ...
      const imageRef = ref(
        storage,
        `ProfileImage/${updatedProfileImage.name + v4().substring(0, 4)}`
      );

      uploadBytes(imageRef, updatedProfileImage)
        .then((snapshot) => {
          ...
          <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
            ...
            <div className="w-full">
              ...
              <p className="text-dark-grey -mt-3">
                Username is used to search users and will be visible to all
              </p>
              <textarea
                name="bio"
                maxLength={bioLimit}
